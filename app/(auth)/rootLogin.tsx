    ...
    return (
        <StyleSafeAreaView className='w-screen h-screen'>
            <StyleScrollView contentContainerStyle={{ width: "100%" }}>
                <StyleView className='w-full h-screen justify-center items-center'>
                    {/* Image Logo */}
                    <StyleView className='w-24 h-24'>
                        <StyleImage source={images.logo} className='w-full h-full' resizeMode='contain' />
                    </StyleView>

                    <StyleView className='mt-10 mx-20 space-y-5'>
                        <StyleText className='font-bold text-3xl'>
                            Let's get Started!
                        </StyleText>
